...
When you first access the Services, you may be presented with a cookie preference interface that allows you to manage your consent for non-essential cookies. You may update your preferences at any time through the “Manage Cookies” settings available on the Services.
                              ...
                              <span>
                                {listParts.map((part, j) => {
                                  if (j % 3 === 1) { // text component of link
                                    ...
                                    return (
                                      <a key={j} href={url} target="_blank" rel="noopener noreferrer" className="text-[#0185EE] hover:underline underline-offset-4">
                                        {part}
                                      </a>
                                    );
                                  }
                        ...
                        return (
                          <p key={i} className="mt-1">
                            {processedParts.map((part, j) => {
                              ...
                              if (linkMatch) {
                                return (
                                  <a key={j} href={linkMatch[2]} target={linkMatch[2].startsWith("http") ? "_blank" : "_self"} rel={linkMatch[2].startsWith("http") ? "noopener noreferrer" : ""} className="text-[#0185EE] hover:underline underline-offset-4">
                                    {linkMatch[1]}
                                  </a>
                                );
                              }
